...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Basket.API.Models.BasketDetails", b =>
                {
            ...
            modelBuilder.Entity("Basket.API.Models.BasketHeader", b =>
                {
                    b.Property<int>("BasketHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Basket.API.Models.Wine", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Basket.API.Models.BasketDetails", b =>
                {
                    b.HasOne("Basket.API.Models.BasketHeader", "BasketHeader")
                        .WithMany()
                        .HasForeignKey("BasketHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Basket.API.Models.Wine", "Wine")
                        .WithMany()
